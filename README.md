...
- [Новое в версии 1.1.2](#новое-в-версии-112)
...
**LLM:**
Если вы используете встроенный механизм запуска, скачайте модель формата GGUF (в установщике используется Qwen3.5-2B-Q4_K_M) и поместите файл в корень проекта.
...
## Конфигурация
В установленной версии файл находится в `%LOCALAPPDATA%\Vera\data\config.json`, при запуске из исходников — в `data/config.json` проекта.
