"""
Единые паттерны для оценки успешности результатов выполнения.

Используется модулями executor и reflector для определения,
считается ли результат шага успешным или неудачным.
"""
